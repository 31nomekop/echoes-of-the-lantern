const ECHOES = [
  { id: "glow-wisp", name: "Glow Wisp", type: "wisp", discovered: false, x: 1120, y: 640 }
];
...
function drawEchoes(ctx, camera, tick = 0, shrineActivated = false){
  ECHOES.forEach(e => {
    if(e.discovered || !shrineActivated) return;
...
function checkEchoDiscovery(player, shrineActivated, onDiscover){
